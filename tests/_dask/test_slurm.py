...
from fasthep_distributed._dask._slurm import (
...
def test_slurm_cluster_scales_workers_and_computes_tasks(
    ...
    monkeypatch.setattr(
        "fasthep_distributed._dask._slurm.DaskPooledSlurmCluster",
...
def test_dask_backend_dispatches_to_slurm(
    ...
    monkeypatch.setattr(
        "fasthep_distributed._dask._slurm.compute_with_slurm",
